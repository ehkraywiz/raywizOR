...
import {StatuslightWidgetConfig} from "@dashboard/widgets/statuslight-widget";

@customElement("statuslight-settings")
export class StatuslightSettings extends WidgetSettings {
