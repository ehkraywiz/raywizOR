...
public class TrafficDataAsset extends Asset<TrafficDataAsset> {
    ...
    public static final AttributeDescriptor<String> leverandor = new AttributeDescriptor<>("Leverandør", ValueType.TEXT,    new MetaItem<>(MetaItemType.AGENT_LINK), new MetaItem<>(MetaItemType.RULE_STATE));
    ...
    public static final AttributeDescriptor<Integer> objectID = new AttributeDescriptor("Objekt ID", ValueType.INTEGER,     new MetaItem<>(MetaItemType.AGENT_LINK), new MetaItem<>(MetaItemType.RULE_STATE), new MetaItem<>(MetaItemType.STORE_DATA_POINTS));
    ...
    public static final AttributeDescriptor<Double> direction = new AttributeDescriptor<>("Retning", ValueType.NUMBER,      new MetaItem<>(MetaItemType.AGENT_LINK), new MetaItem<>(MetaItemType.RULE_STATE), new MetaItem<>(MetaItemType.STORE_DATA_POINTS));
    ...
    public static final AttributeDescriptor<Double> height = new AttributeDescriptor<>("Objekthøyde", ValueType.NUMBER,     new MetaItem<>(MetaItemType.AGENT_LINK), new MetaItem<>(MetaItemType.RULE_STATE), new MetaItem<>(MetaItemType.STORE_DATA_POINTS)).withUnits(UNITS_METRE);
    ...
    public static final AttributeDescriptor<Double> DENM = new AttributeDescriptor<>("DENM-kode", ValueType.NUMBER,         new MetaItem<>(MetaItemType.AGENT_LINK), new MetaItem<>(MetaItemType.RULE_STATE), new MetaItem<>(MetaItemType.STORE_DATA_POINTS));
