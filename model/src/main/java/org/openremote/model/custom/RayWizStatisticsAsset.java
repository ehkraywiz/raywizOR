...
public class RayWizStatisticsAsset extends Asset<RayWizStatisticsAsset> {
    public static final AssetDescriptor<RayWizStatisticsAsset> statisticsAssetAssetDescriptor = new AssetDescriptor<>("chart-line", "85a34f", RayWizStatisticsAsset.class);
